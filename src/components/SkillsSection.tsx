        ...
        <div>
            ...
            <div className="flex flex-col lg:flex-row">
                <Skill
                    ...
                    subtitle={
                        <p className="text-sm text-grisjoli">
                            I love build dynamic user interfaces with the js
                            framework{" "}
                            <Code>
                ...
                <Skill
                    ...
                    subtitle={
                        <p className="text-sm text-grisjoli">
                            I develop robust backend systems using my favorite
                            framework,{" "}
                            <Code>
                ...
                <Skill
                    ...
                    subtitle={
                        <p className="text-sm text-grisjoli">
                            I design modern, responsive and beautifull layouts
                            with{" "}
                            <Code>
                                <TailwindIcon size={13} class="mr-1" />
                                Tailwind
                            </Code>
                            , utilizing utility-first styles for flexible
                            design.
                        </p>
                    }
                />
